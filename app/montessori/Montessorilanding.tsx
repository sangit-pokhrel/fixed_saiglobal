...
const MontessoriLanding = () => {
    const [activeSection, setActiveSection] = useState('grade10');
  ...
  return (
    ...
    <div className="relative w-full h-48 flex items-center justify-center text-center">
        ...
        <div className="relative text-white">
            <h1 className="text-5xl font-bold underline underline-offset-8">ACADEMICS MONTESSORI</h1>
    ...
    <div className="relative flex justify-center py-16 bg-gray-100">
        ...
        <div className="relative z-10 bg-white bg-opacity-90 p-8 shadow-lg max-w-4xl">
                ...
                <div>
                    <h2 className="text-4xl font-bold mb-4 text-center">Grade 1 to 10</h2>
...
export default MontessoriLanding