...
const PlusTwoLanding = () => {
    const [activeSection, setActiveSection] = useState('plustwo');
  ...
  return (
    ...
    <div className="relative w-full h-48 flex items-center justify-center text-center">
        ...
        <div className="relative text-white">
            <h1 className="text-5xl font-bold underline underline-offset-8">ACADEMICS +2</h1>
